package jdbc.basico.dao.connection;

import java.sql.Connection;
import java.sql.DriverManager;
import java.sql.SQLException;

public class ExempleConnectionJDBC {

	private final static String urlConnection = "jdbc:mysql://localhost:3306/digital_innovation_one";
	private final static String user = "root";
	private final static String pwd = "mysql123";
	...
	public static void main(String[] args){
		...
		try (Connection conn = DriverManager.getConnection(urlConnection, user, pwd)){
			...
			System.out.println("Ocorreu um erro ao conectar no banco!\n");
			e.printStackTrace();
		}
